      ...
      <div className="projects-container">
        ...
        <div className="projects-site">
          ...
          <div className="project-thumbnails">
            <a href="https://froogalapp.herokuapp.com/" target="_blank" rel="noopener noreferrer" className="project-links"><img src={project1} alt="project1"/></a>
            <a href="https://perfectweek.herokuapp.com/" target="_blank" rel="noopener noreferrer" className="project-links"><img src={project2} alt="project2"/></a>
            <a href="https://todo-list-amg22.herokuapp.com/" target="_blank" rel="noopener noreferrer" className="project-links"><img src={project3} alt="project3"/></a>
